...
type FullEntity_Asset_Fragment = { __typename?: 'Asset', id: string, type: string, form?: Maybe<(
    { __typename?: 'Form' }
    & EditFormFragment
  )>, title: Array<Maybe<{ __typename: 'Metadata', key: string, value: string, label: string, immutable?: Maybe<boolean> } | { __typename: 'MetadataRelation' }>>, media?: Maybe<{ __typename?: 'Media', mediafiles?: Maybe<Array<Maybe<{ __typename?: 'MediaFile', _id: string, filename?: Maybe<string>, thumbnail_file_location?: Maybe<string>, mimetype?: Maybe<string>, metadata?: Maybe<Array<Maybe<{ __typename?: 'MediaFileMetadata', key?: Maybe<string>, value?: Maybe<string> }>>> }>>> }> };
