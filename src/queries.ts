...
export type Mutation = {
  ...
  postMediaFile?: Maybe<Scalars['String']>;
...
export type MinimalBaseEntityFragment = MinimalBaseEntity_Asset_Fragment | MinimalBaseEntity_BaseEntity_Fragment | MinimalBaseEntity_Frame_Fragment | MinimalBaseEntity_Story_Fragment | MinimalBaseEntity_BoxEntity_Fragment | MinimalBaseEntity_Museum_Fragment | MinimalBaseEntity_Person_Fragment;
...
export type FullEntityFragment = FullEntity_Asset_Fragment | FullEntity_BaseEntity_Fragment | FullEntity_Frame_Fragment | FullEntity_Story_Fragment | FullEntity_BoxEntity_Fragment | FullEntity_Museum_Fragment | FullEntity_Person_Fragment;
...
export type FullEntityRecursiveFragment = FullEntityRecursive_Asset_Fragment | FullEntityRecursive_BaseEntity_Fragment | FullEntityRecursive_Frame_Fragment | FullEntityRecursive_Story_Fragment | FullEntityRecursive_BoxEntity_Fragment | FullEntityRecursive_Museum_Fragment | FullEntityRecursive_Person_Fragment;
...
export type PostMediaFileMutation = { __typename?: 'Mutation', postMediaFile?: Maybe<string> };
...
export const PostMediaFileDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"postMediaFile"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"entityId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"mediaFileInput"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MediaFileInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"file"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Upload"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"postMediaFile"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"entityId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"entityId"}}},{"kind":"Argument","name":{"kind":"Name","value":"mediaFileInput"},"value":{"kind":"Variable","name":{"kind":"Name","value":"mediaFileInput"}}},{"kind":"Argument","name":{"kind":"Name","value":"file"},"value":{"kind":"Variable","name":{"kind":"Name","value":"file"}}}]}]}}]} as unknown as DocumentNode<PostMediaFileMutation, PostMediaFileMutationVariables>;
