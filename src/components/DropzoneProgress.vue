<template>
  <div
    v-show="progress.status === 'inProgress'"
    class="fixed w-14 h-14 bg-neutral-900 rounded-full bottom-5 right-10 flex flex-col justify-center transform items-center"
  >
