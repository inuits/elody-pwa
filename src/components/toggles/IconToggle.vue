<template>
  <label class="w-20 h-full toggle flex items-center cursor-pointer">
    ...
    <div :class="['box', forceFlexClass ? 'forceFlex' : '']">
      ...
      />
      <div class="dot"></div>
      <BaseIcon :name="iconOff" class="iconOff bg-background-light" />
      <BaseIcon :name="iconOn" class="iconOn bg-background-light" />
    </div>
