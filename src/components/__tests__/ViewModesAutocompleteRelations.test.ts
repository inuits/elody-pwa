...
describe("ViewModesAutocompleteRelations", () => {
  ...
  it("sets the related options to 2 and all to 0", async () => {
    ...
    // await flushPromises();
    expect(wrapper.vm.advancedFilterInputForRetrievingAllOptions.length).toBe(0);
    expect(wrapper.vm.advancedFilterInputForRetrievingRelatedOptions.length).toBe(2);
  });
  ...
  it("sets the related options to 2 and all to 1", async () => {
    ...
    // await flushPromises();
    expect(wrapper.vm.advancedFilterInputForRetrievingAllOptions.length).toBe(1);
    expect(wrapper.vm.advancedFilterInputForRetrievingRelatedOptions.length).toBe(2);
  });
  ...
  it("sets the related options to 1 and all to 1", async () => {
    ...
    // await flushPromises();
    expect(wrapper.vm.advancedFilterInputForRetrievingAllOptions.length).toBe(1);
    expect(wrapper.vm.advancedFilterInputForRetrievingRelatedOptions.length).toBe(1);
  });
