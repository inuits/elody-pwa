<template>
  <li
    ...
    <input type="checkbox" class="rounded" :checked="isChecked" @change="handleCheckboxChange" />

    <div class="flex items-center"></div>
    <div class="flex w-full items-center" :class="{ 'flex-col': small && !thumbIcon }">
      <img v-if="media && !imageSrcError"
        class="h-10 w-10 object-cover mr-4 rounded-sm outline-none shadow-sm self-center" :src="
