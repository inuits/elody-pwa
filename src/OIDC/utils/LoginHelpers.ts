...
export const postCode = (authCode: string, repository: OpenIdConnectRepositoryInterface, authorizedRedirectRoute: string) => {
...
export const checkLoggedIn = (repository: OpenIdConnectRepositoryInterface): Promise<boolean> => {
...
export const login = (OIDCconfig: OpenIdConnectConfiguration, finalRedirectRoute?: string) => {
