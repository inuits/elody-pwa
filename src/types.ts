...
export const Unicons: Record<DamsIcons, { name: string }> = {
  ...
  Building: uniBuilding,
  Car: uniCar,
  Comments: uniComments,
  CompressAlt: uniCompressAlt,
  Channel: uniChannel,
  ChannelAdd: uniChannelAdd,
  Cancel: uniCancel,
  Crop: uniCropAlt,
  Check: uniCheck,
  ...
  Export: uniExport,
  ExpandAlt: uniExpandAlt,
  ExternalLinkAlt: uniExternalLinkAlt,
  Eye: uniEye,
  ...
  Folder: uniFolder,
  FolderPlus: uniFolderPlus,
  Font: uniFont,
  Globe: uniGlobe,
  GripHorizontalLine: uniGripHorizontalLine,
  Hdd: uniHdd,
  History: uniHistory,
  Home: uniHome,
  Image: uniImage,
